# Chrome Web Store Privacy Fields - English

## Single Purpose

This extension lets users compare their own Threads or Instagram following and followers lists from an official local data export file. It shows accounts the user follows that do not appear in the followers export.
...
Used to provide the extension interface in Chrome's side panel.
...
## Data Sale or Transfer Certifications
